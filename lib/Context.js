...
var Context = function (_React$Component) {
  ...
  _createClass(Context, [{
    ...
    value: function onLoad() {
      ...
      this.startupHook = MathJax.Hub.Register.StartupHook('End', function () {
      ...
      this.processingErrorHook = MathJax.Hub.Register.MessageHook("Math Processing Error", function (message) {
